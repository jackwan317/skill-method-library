...
| Anthropic `knowledge-synthesis` | https://github.com/anthropics/knowledge-work-plugins/tree/main/enterprise-search/skills/knowledge-synthesis | 企业搜索 / 多源知识综合 | Anthropic 官方；knowledge-work-plugins 约 21k stars/2.5k forks；处理去重、freshness/authority、source attribution。 | 待生成 | 新增候选 |
